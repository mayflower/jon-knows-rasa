...
RUN pip install -r requirements.txt && pip install sklearn_crfsuite spacy && python -m spacy download de_core_news_sm && python -m spacy link de_core_news_sm de && .create_models.sh
